...
import yincheng.gggithub.mvparchitecture.internal.DelegatedTiActivity;
import yincheng.gggithub.mvparchitecture.internal.InterceptableViewBinder;
import yincheng.gggithub.mvparchitecture.internal.PresenterAccessor;
import yincheng.gggithub.mvparchitecture.internal.PresenterSavior;
import yincheng.gggithub.mvparchitecture.internal.TiActivityDelegate;
import yincheng.gggithub.mvparchitecture.internal.TiLoggingTagProvider;
import yincheng.gggithub.mvparchitecture.internal.TiPresenterProvider;
import yincheng.gggithub.mvparchitecture.internal.TiViewProvider;
import yincheng.gggithub.mvparchitecture.internal.UiThreadExecutor;
import yincheng.gggithub.mvparchitecture.util.AnnotationUtil;
      ...
      if (foundViewInterface == null) {
         throw new IllegalArgumentException(
               "This Activity doesn't implement a TiView interface. "
                     + "This is the default behaviour. Override provideView() to explicitly " +
                     "change this.");
      } else {
