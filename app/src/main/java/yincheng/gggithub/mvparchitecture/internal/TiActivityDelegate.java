...
import yincheng.gggithub.mvparchitecture.BindViewInterceptor;
import yincheng.gggithub.mvparchitecture.Removable;
import yincheng.gggithub.mvparchitecture.TiActivity;
import yincheng.gggithub.mvparchitecture.TiConfiguration;
...
import yincheng.gggithub.mvparchitecture.callonmainthread.CallOnMainThreadInterceptor;
import yincheng.gggithub.mvparchitecture.distinctuntilchanged.DistinctUntilChangedInterceptor;

/**
 * This delegate(委托，代表) allows sharing the activity code between the {@link TiActivity} and {@code
